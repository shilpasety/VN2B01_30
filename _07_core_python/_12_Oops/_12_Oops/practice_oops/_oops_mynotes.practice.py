...
data and methods to acheive the task.Each class performing several inter related tasks for which several methods
written in a class

procedure oriented programming system: c, fortran, pascal
in this approach main task is divide into sub tasks and each sub task is represented as a function/procedure.

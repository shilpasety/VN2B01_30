...
def func():
    x = "Python"
    print(x)
    print(s)  #since 's' is a global variable any function can use that in the program
s = "language"
print(s)
func()
# print(x)
...
it is defined (func() above) and trying to call local variable outside its scope(func()) will throw an Error. 
...
So trying to use local variable outside their scope, might throw NameError. 
...
print_even_odd(st, end)   # function calling
